#!/bin/bash
#SBATCH --job-name=RAE_s1_siglip2_in100
...
EXP_PREFIX="${EXP_PREFIX:-SIGLIP2_IN100_}"
...
CONFIGS=(
  "SigLIP2_decB.yaml"
  "SigLIP2_decB_Patch+Pooler_AdaLN.yaml"
  "SigLIP2_decB_Patch+Pooler_prepend.yaml"
  "SigLIP2_decB_Patch+Pooler_CA.yaml"
)
